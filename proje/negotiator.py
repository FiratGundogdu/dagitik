    ...
    def run(self):
        ...
        while True:
            if self.queue.qsize()>0:
                ...
                #Negator peere baglanti yapamassa  REGER  cevabini donduruyor
                try:
...
#Bu thread 120 sn bir listedeki baglantilarin devam edip  etmedigini kontrol etmekte
...
#Bu thread 10 sn de bir guncel listeyi tum peerlere  gonderiyor
class ClientSendUpdateList(threading.Thread):
      ...
      def run(self):
          ...
          while True:
              ...
              global connect_point_list
              #sistem de  kayitli kisi  sayisi  birden fazla  ise
